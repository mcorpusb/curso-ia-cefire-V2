---
layout: page
title: "Herramientas de IA actualizadas"
nav_order: 8
description: "Tabla de referencia de herramientas de IA para docentes: modalidad gratuita, límites, privacidad y enlaces oficiales. Actualización 2026."
---
...
|---|---|---|---|---|---|---|
| **Canva** (con IA) | Presentaciones, infografías, vídeos, imágenes IA | Sí · Canva Education 100% gratuito para docentes K-12 verificados | Algunas funciones Pro en plan gratuito general; Plan Education sin límites relevantes | Canva (verificación docente) | ✅ Canva Education cumple FERPA/COPPA; datos de alumnado protegidos | [canva.com/education](https://www.canva.com/education/) |
...
**Importante · Comprueba en tu cuenta antes de usar en el aula**

Existen **dos productos distintos** con el nombre "Copilot" en el entorno Microsoft:
...
- Requiere licencia de pago adicional (~18 €/usuario/mes sobre M365).
- **No está incluido en la licencia estándar de GVA.** Algunos centros concertados o privados pueden tenerlo. **Verifica en tu departamento TIC.**

En este curso trabajamos con **Copilot Chat** (gratuito). Las funciones de Microsoft 365 Copilot se mencionan a modo informativo cuando son relevantes.
